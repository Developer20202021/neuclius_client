...
useEffect(()=>{
  ...
  .finally(()=>{
    ...
    const columns = [
        ...
        { field: 'teacherID', headerName: 'ID', width: 100 },
        {
          field: "url",
          headerName: "image",
          sortable: false,
...

        {
          ...
          renderCell: (params) => {
            const getItem = (id)=>{
              history.push(`/dashboard/teacher-view-details/${id}`)
...

        {
          ...
          renderCell: (params) => {
              const getItem = (id)=>{
                  history.push(`/dashboard/edit-teacher/${id}`)
             console.log(id);
              }
              // console.log(params);
            return (
...
<FormControl  sx={{ m: 1, minWidth: 220 }}>
        ...
        >
          <MenuItem value={"Exam"}>Due</MenuItem>
          <MenuItem value={"Class"}>Paid</MenuItem>
