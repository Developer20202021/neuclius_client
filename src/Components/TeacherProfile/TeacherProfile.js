    ...
    <Grid item md={12} lg={4} xs={12}>
        ...
        <div className="img-container">
             ...
             <div className="title-d">
                          ...
                          <div className='routine-des'>  <p className='title-type-d'>Teacher ID:</p>   <span class="badge badge-soft-info font-size-12">A3244</span>  </div>
                      
                          <div className='routine-des'>  <p className='title-type-d'>Phone:</p>  <p className='title-n'>+0880172191550</p>  </div>
                          <div className='routine-des'>  <p className='title-type-d'>Subject:</p>  <span class="badge badge-soft-info font-size-12">Biology</span>  </div>
                          <div className='routine-des'>  <p className='title-type-d'>Role:</p>  <span class="badge badge-soft-danger font-size-12">Teacher</span>  </div>
...
<span class="badge  badge-soft-danger font-size-12">M Abdur Rahim Medical College, Dinajpur</span>
    ...
    <div className="setting">
     ...
     <div className="title-d">
                  ...
                  <div className='routine-des'>  <p className='title-type-d'>Teacher ID:</p>   <span class="badge badge-soft-info font-size-12">A3244</span>  </div>
                  <div className='routine-des'>  <p className='title-type-d'>Subject:</p>  <span class="badge badge-soft-info font-size-12">Biology</span>  </div>
                  <div className='routine-des'>  <p className='title-type-d'>NID:</p>  <span class="badge  badge-soft-danger font-size-12">12321415534134</span> </div>
                  ...
                  <div className='routine-des'>  <p className='title-type-d'>Session:</p>  <p className='title-n'>2020</p>  </div>
